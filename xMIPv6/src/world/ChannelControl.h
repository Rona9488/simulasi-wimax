...
#include <set>
#include <omnetpp.h>
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\linklayer\mfcore\AirFrame_m.h"
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\base\Coord.h"
...
class INET_API ChannelControl : public inet::cSimpleModule
{
  protected:
    struct HostEntry;
  ...
  protected:
    ...
    inet::simtime_t lastOngoingTransmissionsUpdate;
  ...
  public:
    ...
    virtual HostRef registerHost(cModule *host, const Coord& initialPos, inet::cGate *radioInGate=NULL);
    ...
    inet::cGate *getRadioGate(HostRef h) const {return h->radioInGate;}
