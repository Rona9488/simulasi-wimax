...
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\transport\contract\TCPSocket.h"
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\transport\contract\TCPSocketMap.h"
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\networklayer\mpls\IClassifier.h"
 ...
 */
class INET_API LDP: public inet::cSimpleModule, public TCPSocket::CallbackInterface, public IClassifier, public INotifiable
{
  public:
    ...
    struct peer_info
    {
        ...
        inet::cMessage *timeout;
    };
    typedef std::vector<peer_info> PeerVector;

  protected:
    // configuration
    inet::simtime_t holdTime;
  ...
  protected:
    ...
    virtual void sendToPeer(IPAddress dest, inet::cMessage *msg);
  ...
  protected:
    ...
    virtual void processHelloTimeout(inet::cMessage *msg);
    virtual void processMessageFromTCP(inet::cMessage *msg);
    ...
    virtual void socketDataArrived(int connId, void *yourPtr, inet::cPacket *msg, bool urgent);
    ...
    // INotifiable
    virtual void receiveChangeNotification(int category, const inet::cObject *details);
};
