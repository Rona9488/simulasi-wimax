...
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\networklayer\rsvp_te\SignallingMsg_m.h"
 ...
 * TODO documentation
 */
class INET_API RSVP : public inet::cSimpleModule, public IScriptable
{
  protected:
    ...
    inet::simtime_t helloInterval;
    inet::simtime_t helloTimeout;
    inet::simtime_t retryInterval;
  ...
  protected:
    ...
    virtual void scheduleRefreshTimer(PathStateBlock_t *psbEle, inet::simtime_t delay);
    virtual void scheduleTimeout(PathStateBlock_t *psbEle);
    virtual void scheduleRefreshTimer(ResvStateBlock_t *rsbEle, inet::simtime_t delay);
    ...
    virtual void sendPathNotify(int handler, const SessionObj_t& session, const SenderTemplateObj_t& sender, int status, inet::simtime_t delay);

    virtual void setupHello();
    virtual void startHello(IPAddress peer, inet::simtime_t delay);
    ...
    virtual void sendToIP(inet::cMessage *msg, IPAddress destAddr);
    ...
    virtual void readTrafficFromXML(const inet::cXMLElement *traffic);
    virtual void readTrafficSessionFromXML(const inet::cXMLElement *session);
    virtual EroVector readTrafficRouteFromXML(const inet::cXMLElement *route);
    ...
    virtual void addSession(const inet::cXMLElement& node);
    virtual void delSession(const inet::cXMLElement& node);
