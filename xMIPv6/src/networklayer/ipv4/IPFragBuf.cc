...
IPDatagram *IPFragBuf::addFragment(IPDatagram *datagram, inet::simtime_t now)
{
    ...
    if (datagram->getObject("encapsulatedMessage"))
    {
        delete buf->datagram;
...
void IPFragBuf::purgeStaleFragments(inet::simtime_t lastupdate)
{
