...
class INET_API IP : public QueueBase
{
  protected:
    ...
    inet::cGate *queueOutGate; // the most frequently used output gate

    // config
    int defaultTimeToLive;
    int defaultMCTimeToLive;
    inet::simtime_t fragmentTimeoutTime;
  ...
  protected:
     ...
     */
    virtual IPDatagram *encapsulate(inet::cPacket *transportPacket, InterfaceEntry *&destIE);
     ...
     */
    virtual IPDatagram *encapsulate(inet::cPacket *transportPacket, InterfaceEntry *&destIE, IPControlInfo *controlInfo);
     ...
     */
    virtual inet::cPacket *decapsulateIP(IPDatagram *datagram);
