 ...
 * ICMP module.
 */
class INET_API ICMP : public inet::cSimpleModule
{
  protected:
    ...
    virtual void sendEchoRequest(inet::cPacket *);
  ...
  public:
     ...
     */
    virtual void sendErrorMessage(inet::cPacket *transportPacket, IPControlInfo *ctrl, ICMPType type, ICMPCode code);
