...
inline void INET_API doPacking(omnetpp::cCommBuffer *buf, const IPv6Address& addr)
{
    buf->pack(addr.words(), 4);
}

inline void INET_API doUnpacking(omnetpp::cCommBuffer *buf, IPv6Address& addr)
{
