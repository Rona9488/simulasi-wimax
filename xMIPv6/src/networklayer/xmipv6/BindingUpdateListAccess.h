...
/**
 * Gives access to BindingUpdateList
 */
class INET_API BindingUpdateListAccess : public ModuleAccess<BindingUpdateList>
{
    public:
        BindingUpdateListAccess() : ModuleAccess<BindingUpdateList>("buList") {}
};
