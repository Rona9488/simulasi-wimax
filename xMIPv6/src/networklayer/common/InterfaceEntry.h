 ...
 */
class INET_API InterfaceProtocolData : public omnetpp::cObject
{
 ...
 * @see IInterfaceTable
 */
class INET_API InterfaceEntry : public omnetpp::cObject
{
  ...
  public:
    ...
    /** @name Field setters */
    //@{
    virtual void setName(const char *s)  {omnetpp::cObject::isName(s); configChanged();}
