...
#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\world\ChannelAccess.h"
...
class INET_API BasicSnrEval : public ChannelAccess
{
  ...
  protected:
     ...
     * of self messages
     */
    virtual void handleSelfMsg(inet::cMessage *msg){delete msg;};
    ...
    virtual AirFrame* unbufferMsg(inet::cMessage *msg);
    ...
    virtual AirFrame *encapsMsg(inet::cPacket *msg);
    /*@}*/

    /** @brief This function calculates the duration of the AirFrame */
    virtual double calcDuration(inet::cPacket *);
