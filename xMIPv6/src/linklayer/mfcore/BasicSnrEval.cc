...
#define coreEV (coreDebug ? std::cout << logName() << "::BasicSnrEval: " : std::cout)
...
void BasicSnrEval::initialize(int stage)
{
    ...
    coreEV << "Initializing BasicSnrEval, stage=" << stage << std::endl;
 ...
 * handleSelfMsg
 */
void BasicSnrEval::handleMessage(inet::cMessage *msg)
{
 ...
 * AirFrame.
 */
AirFrame *BasicSnrEval::encapsMsg(inet::cPacket *msg)
{
 ...
 */
double BasicSnrEval::calcDuration(inet::cPacket *af)
{
    double duration;
 ...
 */
AirFrame *BasicSnrEval::unbufferMsg(inet::cMessage *msg)
{
...
{
    coreEV << "in handleLowerMsgStart, receiving frame " << frame->getName() << std::endl;
