...
////
//
//void SCTPAssociation::process_ASSOCIATE(SCTPEventCode& event, SCTPCommand *sctpCommand, inet::cPacket *msg)
//{
...
//}
//
//void SCTPAssociation::process_OPEN_PASSIVE(SCTPEventCode& event, SCTPCommand *sctpCommand, inet::cPacket *msg)
//{
//	IPvXAddress lAddr;
//	int16_t localPort;
//
...
//}
//
//void SCTPAssociation::process_SEND(SCTPEventCode& event, SCTPCommand *sctpCommand, inet::cPacket *msg)
//{
//uint32_t pkSize=0, streamId, sendUnordered, ppid=0;
...
//					stream=iter->second;
//				else
//					throw inet::cException("stream with id %d not found",streamId);
//				char stri[20];
...
//}
//
//void SCTPAssociation::process_STATUS(SCTPEventCode& event, SCTPCommand *sctpCommand, inet::cPacket *msg)
//{
