...
class INET_API TCPSocket
{
  public:
    ...
    class CallbackInterface
    {
      public:
        ...
        virtual void socketDataArrived(int connId, void *yourPtr, inet::cPacket *msg, bool urgent) = 0;
  ...
  protected:
    void sendToTCP(inet::cMessage *msg);
  ...
  public:
     ...
     */
    void setOutputGate(inet::cGate *toTcp)  {gateToTcp = toTcp;}
     ...
     * TCPSocket(inet::cMessage *msg) constructor.
     *
     ...
     */
    static bool belongsToAnyTCPSocket(inet::cMessage *msg);
