...
//        virtual void socketDataArrived(int assocId, void *yourPtr, inet::cPacket *msg, bool urgent) = 0;
//	virtual void socketDataNotificationArrived(int assocId, void *yourPtr, inet::cPacket *msg) = 0;
...
//	void *yourPtr;
//
//	void sendToSCTP(inet::cPacket *msg);
//
//	public:
//	inet::cGate *gateToSctp;
//    /**
...
//     */
//    	void setOutputGate(inet::cGate *toSctp)  {gateToSctp = toSctp;};
...
//     */
//	 void listen(bool fork=false, uint32_t requests=0, uint32_t messagesToPush=0);
//    /**
//     * Active OPEN to the given remote socket.
//     */
//    	void connect(IPvXAddress remoteAddress, int32_t remotePort, uint32_t numRequests);
//
//	 void connectx(AddressVector remoteAddresses, int32_t remotePort, uint32_t numRequests);
//    /**
//     * Sends data packet.
//     */
//    	void send(inet::cPacket *msg, bool last=true, bool primary=true);
//
//	void sendNotification(inet::cPacket *msg);
//    	void sendRequest(inet::cPacket *msg);
//    /**
...
//     * that of the socket.)
//     */
//    	bool belongsToSocket(inet::cPacket *msg);
//
//    /**
...
//     * it as controlInfo().)
//     */
//    	static bool belongsToAnySCTPSocket(inet::cPacket *msg);
//
//    /**
...
//     * return true!
//     */
//    	void processMessage(inet::cPacket *msg);
//    //@}
//};
//
//#endif
