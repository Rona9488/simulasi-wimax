...
class INET_API TCPSegment : public TCPSegment_Base
{
  ...
  public:
    ...
    virtual void parsimPack(inet::cCommBuffer *b);
    virtual void parsimUnpack(inet::cCommBuffer *b);
     ...
     */
    virtual void addPayloadMessage(inet::cPacket *msg, uint32_t endSequenceNo);
     ...
     */
    virtual inet::cPacket *removeFirstPayloadMessage(uint32_t & outEndSequenceNo);
};
