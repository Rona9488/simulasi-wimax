 ...
 * @see TCPReceiveQueue
 */
class INET_API TCPSendQueue : public inet::cObject
{
  protected:
  ...
  public:
     ...
     * delete it.)
     */
    virtual void enqueueAppData(inet::cPacket *msg) = 0;
     ...
     */
    virtual uint32_t getBufferEndSeq() = 0;
     ...
     */
    virtual TCPSegment *createSegmentWithBytes(uint32_t fromSeq, ulong maxNumBytes) = 0;
     ...
     */
    virtual void discardUpTo(uint32_t seqNum) = 0;
