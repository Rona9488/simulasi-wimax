...
TCPSegment::~TCPSegment()
{
    ...
    {
        inet::cPacket *msg = payloadList.front().msg;
        payloadList.pop_front();
        dropAndDelete(msg);
    }
}

void TCPSegment::parsimPack(inet::cCommBuffer *b)
{
//    TCPSegment_Base::parsimPack(b);
//    doPacking(b, payloadList);
}

void TCPSegment::parsimUnpack(inet::cCommBuffer *b)
{
...
{
    throw inet::cRuntimeError(this, "setPayloadArraySize() not supported, use addPayloadMessage()");
}
...
{
    throw inet::cRuntimeError(this, "setPayload() not supported, use addPayloadMessage()");
}

void TCPSegment::addPayloadMessage(inet::cPacket *msg, uint32_t endSequenceNo)
{
    take(msg);
...
inet::cPacket *TCPSegment::removeFirstPayloadMessage(uint32_t& endSequenceNo)
{
