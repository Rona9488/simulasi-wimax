...
////
//
//void TCPConnection::process_OPEN_ACTIVE(TCPEventCode& event, TCPCommand *tcpCommand, inet::cMessage *msg)
//{
...
//                throw inet::cException("Error processing command OPEN_ACTIVE: remote address and port must be specified");
//
//            if (localPort==-1)
//            {
...
//
//        default:
//            throw inet::cException("Error processing command OPEN_ACTIVE: connection already exists");
//    }
//
//    delete openCmd;
//    delete msg;
//}
//
//void TCPConnection::process_OPEN_PASSIVE(TCPEventCode& event, TCPCommand *tcpCommand, inet::cMessage *msg)
//{
//    TCPOpenCommand *openCmd = check_and_cast<TCPOpenCommand *>(tcpCommand);
...
//
//            if (localPort==-1)
//                throw inet::cException("Error processing command OPEN_PASSIVE: local port must be specified");
//
...
//
//        default:
//            throw inet::cException("Error processing command OPEN_PASSIVE: connection already exists");
//    }
//
//    delete openCmd;
//    delete msg;
//}
//
//void TCPConnection::process_SEND(TCPEventCode& event, TCPCommand *tcpCommand, inet::cMessage *msg)
//{
...
//    {
//        case TCP_S_INIT:
//            throw inet::cException("Error processing command SEND: connection not open");
//
//        case TCP_S_LISTEN:
...
//            throw inet::cException("Error processing command SEND: connection closing");
//    }
//
//    delete sendCommand; // msg itself has been taken by the sendQueue
//}
//
//void TCPConnection::process_CLOSE(TCPEventCode& event, TCPCommand *tcpCommand, inet::cMessage *msg)
//{
//    delete tcpCommand;
//    delete msg;
//
...
//    {
//        case TCP_S_INIT:
//            throw inet::cException("Error processing command CLOSE: connection not open");
//
//        case TCP_S_LISTEN:
//            // Nothing to do here
//            break;
...
//            throw inet::cException("Duplicate CLOSE command: connection already closing");
//    }
//}
//
//void TCPConnection::process_ABORT(TCPEventCode& event, TCPCommand *tcpCommand, inet::cMessage *msg)
//{
//    delete tcpCommand;
//    delete msg;
//
...
//    {
//        case TCP_S_INIT:
//            throw inet::cException("Error processing command ABORT: connection not open");
//
//        case TCP_S_SYN_RCVD:
//        case TCP_S_ESTABLISHED:
//        case TCP_S_FIN_WAIT_1:
...
//}
//
//void TCPConnection::process_STATUS(TCPEventCode& event, TCPCommand *tcpCommand, inet::cMessage *msg)
//{
//    delete tcpCommand; // but reuse msg for reply
//
//    if (fsm.getState()==TCP_S_INIT)
//        throw inet::cException("Error processing command STATUS: connection not open");
//
