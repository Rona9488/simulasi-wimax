...
//#include "C:\Users\ronaa\Downloads\numbat-master (2)\numbat-master\numbat-master\xMIPv6\src\transport\tcp\TCPSendQueue.h"
...
//    state = NULL;
//
//    the2MSLTimer = new inet::cMessage("2MSL");
//    connEstabTimer = new inet::cMessage("CONN-ESTAB");
//    finWait2Timer = new inet::cMessage("FIN-WAIT-2");
//    synRexmitTimer = new inet::cMessage("SYN-REXMIT");
//
...
//    {
//        sndWndVector = new inet::cOutVector("send window");
//        rcvWndVector = new inet::cOutVector("receive window");
//        rcvAdvVector = new inet::cOutVector("advertised window");
//        sndNxtVector = new inet::cOutVector("sent seq");
//        sndAckVector = new inet::cOutVector("sent ack");
//        rcvSeqVector = new inet::cOutVector("rcvd seq");
//        rcvAckVector = new inet::cOutVector("rcvd ack");
//        unackedVector = new inet::cOutVector("unacked bytes");
//        dupAcksVector = new inet::cOutVector("rcvd dupAcks");
//        pipeVector = new inet::cOutVector("pipe");
//        sndSacksVector = new inet::cOutVector("sent sacks");
//        rcvSacksVector = new inet::cOutVector("rcvd sacks");
//        rcvOooSegVector = new inet::cOutVector("rcvd oooseg");
//        sackedBytesVector = new inet::cOutVector("rcvd sackedBytes");
//        tcpRcvQueueBytesVector = new inet::cOutVector("tcpRcvQueueBytes");
//        tcpRcvQueueDropsVector = new inet::cOutVector("tcpRcvQueueDrops");
//    }
//}
//
//TCPConnection::~TCPConnection()
...
//}
//
//bool TCPConnection::processTimer(inet::cMessage *msg)
//{
//    printConnBrief();
...
//}
//
//bool TCPConnection::processAppCommand(inet::cMessage *msg)
//{
//    printConnBrief();
//
//    // first do actions
...
//        default: throw inet::cException("Unknown message kind in app command");
