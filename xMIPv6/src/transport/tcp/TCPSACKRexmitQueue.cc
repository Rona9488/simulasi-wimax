...
//}
//
//uint32_t TCPSACKRexmitQueue::getBufferEndSeq()
//{
//    return end;
//}
//
...
//}
//
//bool TCPSACKRexmitQueue::getSackedBit(uint32_t seqNum)
//{
//    bool found = false;
//
...
//}
//
//uint32_t TCPSACKRexmitQueue::getQueueLength()
//{
//    return rexmitQueue.size();
//}
//
//uint32_t TCPSACKRexmitQueue::getHighestSackedSeqNum()
//{
//    uint32_t tmp_highest_sacked = 0;
//
//    RexmitQueue::iterator i = rexmitQueue.begin();
//    while (i!=rexmitQueue.end())
//    {
...
//}
//
//uint32_t TCPSACKRexmitQueue::getHighestRexmittedSeqNum()
//{
//    uint32_t tmp_highest_rexmitted = 0;
//
//    RexmitQueue::iterator i = rexmitQueue.begin();
//    while (i!=rexmitQueue.end())
//    {
...
//}
//
//uint32_t TCPSACKRexmitQueue::checkRexmitQueueForSackedOrRexmittedSegments(uint32_t fromSeqNum)
//{
//    uint32_t counter = 0;
//
...
//}
//
//uint32_t TCPSACKRexmitQueue::getTotalAmountOfSackedBytes()
//{
//    uint32_t bytes = 0;
//    uint32_t counter = 0;
//
...
//}
//
//uint32_t TCPSACKRexmitQueue::getAmountOfSackedBytes(uint32_t seqNum)
//{
//    uint32_t bytes = 0;
//    uint32_t counter = 0;
//
...
//
//
//uint32_t TCPSACKRexmitQueue::getNumOfDiscontiguousSacks(uint32_t seqNum)
//{
//    uint32_t counter = 0;
//
//    if (rexmitQueue.empty() || seqGE(seqNum,end))
