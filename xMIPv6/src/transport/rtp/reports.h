 ...
 */
class INET_API SenderReport : public inet::cObject
{
 ...
 */
class INET_API ReceptionReport : public inet::cObject
{
    ...
    public:
         ...
         */
        virtual uint getFractionLost();

        /**
         * Sets the fraction of packets lost.
         */
        virtual void setFractionLost(uint fractionLost);
