 ...
 */
class INET_API RTCPPacket : public inet::cPacket
{
    public:
         ...
         * with the getLength() method inherited from inet::cPacket.
         */
...
class INET_API RTCPReceiverReportPacket : public RTCPPacket
{
    ...
    public:
        ...
        /**
         * Return a copy of the inet::cArray of receiver reports stored
         * in the object.
         */
        virtual inet::cArray *getReceptionReports();
...
class INET_API RTCPSDESPacket : public RTCPPacket
{
    ...
    public:
        ...
        /**
         * Returns a copy of the inet::cArray where the sdes chunks are stored.
         */
        virtual inet::cArray *getSdesChunks();
    ...
    protected:
        ...
        /**
         * In this inet::cArray the sdes chunks are stored.
         */
        inet::cArray *_sdesChunks;
};
 ...
 * met.
 */
class INET_API RTCPCompoundPacket : public inet::cPacket
{
    ...
    public:
        ...
        /**
         * Returns a copy of the inet::cArray in which the rtcp
         * packets are stored.
         */
        virtual inet::cArray *getRtcpPackets();

    protected:

        /**
         * The inet::cArray in which the rtcp packets are stored.
         */
        inet::cArray *_rtcpPackets;
