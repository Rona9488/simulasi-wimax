 ...
 */
class INET_API RTPPayloadSender : public inet::cSimpleModule
{
    public: //FIXME
    //protected:
         ...
         */
        RTPPayloadSender() : inet::cSimpleModule(32768) {}
    ...
    protected:
        ...
        must be cancelled.
        */
        inet::cMessage *_reminderMessage;
         ...
         */
        virtual void playUntilTime(inet::simtime_t moment);
        ...
        */
         ...
         * Implementation in sender modules is optional.
         */
        virtual void seekTime(inet::simtime_t moment);
