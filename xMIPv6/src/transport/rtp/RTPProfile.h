 ...
 */
class INET_API RTPProfile : public inet::cSimpleModule
{
    protected:
        ...
        class SSRCGate : public inet::cNamedObject  //FIXME why is it a namedObject?
        {
          protected:
            uint32_t ssrc;
            int gateId;
    ...
    protected:
         ...
         */
        virtual void handleMessageFromRTP(inet::cMessage *msg);

        /**
         * Handles messages coming from the sender module.
         */
        virtual void handleMessageFromPayloadSender(inet::cMessage *msg);

        /**
         * Handles messages coming from a receiver module.
         */
        virtual void handleMessageFromPayloadReceiver(inet::cMessage *msg);
