...
void RTCPPacket::dump(std::ostream& os) const {
    os << "RTCPPacket:" << inet::endl;
    os << "  version = " << _version << inet::endl;
    os << "  padding = " << _padding << inet::endl;
    os << "  count = " << _count << inet::endl;
    os << "  packetType = " << _packetType << inet::endl;
    os << "  rtcpLength = " << getRtcpLength() << inet::endl;
};
...
RTCPReceiverReportPacket::RTCPReceiverReportPacket(const char *name) : RTCPPacket(name) {
    ...
    _ssrc = 0;
    _receptionReports = new inet::cArray("ReceptionReports");
...
RTCPReceiverReportPacket& RTCPReceiverReportPacket::operator=(const RTCPReceiverReportPacket& rtcpReceiverReportPacket) {
    ...
    _receptionReports = new inet::cArray(*(rtcpReceiverReportPacket._receptionReports));
    return *this;
};
...
void RTCPReceiverReportPacket::dump(std::ostream& os) const {
    os << "RTCPReceiverReportPacket:" << inet::endl;
...
inet::cArray *RTCPReceiverReportPacket::getReceptionReports() {
    return new inet::cArray(*_receptionReports);
};
...
void RTCPSenderReportPacket::dump(std::ostream& os) const {
    os << "RTCPSenderReportPacket:" << inet::endl;
...
RTCPSDESPacket::RTCPSDESPacket(const char *name) : RTCPPacket(name) {
    ...
    _sdesChunks = new inet::cArray("SDESChunks");
...
RTCPSDESPacket& RTCPSDESPacket::operator=(const RTCPSDESPacket& rtcpSDESPacket) {
    ...
    _sdesChunks = new inet::cArray(*(rtcpSDESPacket._sdesChunks));
    return *this;
};
...
inet::cArray *RTCPSDESPacket::getSdesChunks() {
    return new inet::cArray(*_sdesChunks);
};
...
RTCPCompoundPacket::RTCPCompoundPacket(const char *name) : cPacket(name) {
    _rtcpPackets = new inet::cArray("RTCPPackets");
...
RTCPCompoundPacket& RTCPCompoundPacket::operator=(const RTCPCompoundPacket& rtcpCompoundPacket) {
    ...
    _rtcpPackets = new inet::cArray(*(rtcpCompoundPacket._rtcpPackets));
    return *this;
};
...
void RTCPCompoundPacket::dump(std::ostream& os) const {
    os << "RTCPCompoundPacket:" << inet::endl;
...
inet::cArray *RTCPCompoundPacket::getRtcpPackets() {
    return new inet::cArray(*_rtcpPackets);
}
