 ...
 * rtp end systems.
 */
class INET_API RTCP : public inet::cSimpleModule
{
    public:
        RTCP();
    ...
    protected:
         ...
         */
        virtual void handleMessageFromUDP(inet::cMessage *msg);

        /**
         * Handles self messages.
         */
        virtual void handleSelfMessage(inet::cMessage *msg);
        ...
        */
         ...
         * socket layer.
         */
        virtual void readRet(inet::cPacket *sifpIn);
    ...
    protected:
         ...
         */
        inet::cOutVector *_rtcpIntervalOutVector;
