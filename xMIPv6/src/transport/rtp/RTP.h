 ...
 */
class INET_API RTP : public inet::cSimpleModule
{
    protected:
    ...
    protected:
         ...
         */
        virtual void handleMessageFromApp(inet::cMessage *msg);

        /**
         * Handles messages received from the profile module.
         */
        virtual void handleMessageFromProfile(inet::cMessage *msg);

        /**
         * Handles messages received from the rtcp module.
         */
        virtual void handleMessageFromRTCP(inet::cMessage *msg);
    ...
    protected:
         ...
         */
        virtual void readRet(inet::cMessage *sifp);
