...
void printNotificationBanner(int category, const inet::cObject *details)
{
    std::cout << "** Notification at T=" << inet::simTime()
            << " to " << inet::getSimulation()->getContextModule()->getFullPath() << ": "
